try:
	...
	import os
	import numpy as np
	rc(session,"open /Users/albertsmith/Documents/GitHub/pyDIFRATE/Struct/rmsfit_prod.last1000ns.NH.dcd_25000.pdb")
	rc(session,"~display")
	rc(session,"~ribbon")
	...
	os.remove("/Users/albertsmith/Documents/GitHub/pyDIFRATE/chimera/chimera_script094639.py")
