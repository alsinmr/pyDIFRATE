...
def d2(c=0,s=None,m=None,mp=0):
    ...
    if m is None or mp is None:
        ...
        return out[0]
try:
	rc(session,"open /Users/albertsmith/Documents/GitHub/pyDIFRATE/chimera/pdb0.pdb")
	load_surface(session,"/Users/albertsmith/Documents/GitHub/pyDIFRATE/chimera/tensors262623.txt",sc=20,theta_steps=100,phi_steps=50,positive_color=(255, 100, 100, 255),negative_color=(100, 100, 255, 255))
	rc(session,"graphics bgColor white")
except:
	print("Error in chimera script")
finally:
	os.remove("/Users/albertsmith/Documents/GitHub/pyDIFRATE/chimera/chimera_script262623.py")
	os.remove("/Users/albertsmith/Documents/GitHub/pyDIFRATE/chimera/tensors262623.txt")
os.remove("/Users/albertsmith/Documents/GitHub/pyDIFRATE/chimera/pdb0.pdb")
