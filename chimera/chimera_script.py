...
try:
	...
	load_surface(session,"/Users/albertsmith/Documents/GitHub/pyDIFRATE/chimera/tensors_174805.txt",sc=2.09,theta_steps=50,phi_steps=25,positive_color=[255, 100, 100, 255],negative_color=[100, 100, 255, 255],marker_pos_color=[100, 255, 100, 255],marker_neg_color=[255, 255, 100, 255])
	rc(session,"display")
	rc(session,"2dlabel text 'Tumbling at 0 and 100000 ps' size 26 x .03 y .92")
	rc(session,"turn x 90")
except:
	pass
finally:
	os.remove("/Users/albertsmith/Documents/GitHub/pyDIFRATE/chimera/chimera_script174805.py")
	os.remove("/Users/albertsmith/Documents/GitHub/pyDIFRATE/chimera/tensors_174805.txt")
