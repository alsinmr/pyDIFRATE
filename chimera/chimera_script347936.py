...
def d2(c=0,s=None,m=None,mp=0):
    ...
    if m is None or mp is None:
        ...
        return out[0]
try:
	load_surface(session,"/Users/albertsmith/Documents/GitHub/pyDIFRATE/chimera/tensors347936.txt",sc=1,theta_steps=100,phi_steps=50,positive_color=(255, 100, 100, 255),negative_color=(100, 100, 255, 255))
	rc(session,"turn x 90")
	rc(session,"set bgColor white")
	rc(session,"lighting full")
	rc(session,"save /Users/albertsmith/Documents/Dynamics/Lipids/POPC/FinalMD_ana/Ct_orientation_analysis/D2_res83_fr2_t0.png ")
except:
	print("Error in chimera script")
finally:
	os.remove("/Users/albertsmith/Documents/GitHub/pyDIFRATE/chimera/chimera_script347936.py")
	os.remove("/Users/albertsmith/Documents/GitHub/pyDIFRATE/chimera/tensors347936.txt")
	rc(session,"exit")
